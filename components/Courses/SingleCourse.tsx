...
const SingleCourse = ({ feature }: { feature: Feature }) => {
    ...
    <>
      ...
      >
        <div className="relative flex h-[16rem] items-center justify-center rounded-[4px] bg-primary group-hover:scale-120 ease-in duration-300">
          <Image src={icon} width={36} height={36} alt="course" className="h-full max-w-full" />
          <div className="flex absolute top-2 justify-between w-full">
            <div className="flex gap-1 items-center bg-orange-600 p-1 px-2 rounded-sm">
              ...
              <p className="text-sm text-white font-semibold font-sans">15 week</p>
            </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between my-2 mt-4">
            <div className="flex gap-2 items-center">
              ...
              <h2 className="text-md font-semibold text-black font-sans">Janet Flaming</h2>
            </div>
            <div className="flex gap-2 items-center">
          ...
          <h2 className="font-bold text-xl font-sans text-black my-3">The Complete HTML & CSS Bootcamp 2024 Edition</h2>
          <div className="flex gap-5 my-2 border-b-2 pb-4">
            <div className="flex gap-1 items-center">
              <HeroIcon iconName='UsersIcon' className="h-5 w-5" />
              <p className="text-sm text-gray-600 font-medium">228 Students</p>
            </div>

            <div className="flex gap-1 items-center">
              <HeroIcon iconName='NewspaperIcon' className="h-5 w-5" />
              <p className="text-sm text-gray-600 font-medium">16 Lessons</p>
            </div>
          </div>

          <div className="font-bold text-md bg-primary text-white rounded-md max-w-[5rem] p-2 flex justify-center my-2">
            {parseInt("4").toLocaleString("en-US", { style: "currency", currency: "INR" })}
          </div>
